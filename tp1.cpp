...
int mayor_vec(int vec[], int tam){                  // busca la posicion del valor maximo de un vector
...
void ordenar(float vec[], int tam, int vec_pos[]){  // funcion para ordenar las posiciones
...
int main(){
    ...
    int cantmax[ncli]{};                        // contador para el cliente con mayor cantidad tipos de productos que hayan superado 13000 kg
    ...
    int mayorcant = mayor_vec(cantmax, ncli);   // posicion del cliente con mayor cantidad tipos de productos que hayan superado 13000 kg
